      ...
      >
        ...
        <Box display={"flex"} flexDirection={"column"} gap={"30px"}>
          ...
          <Stack display={"flex"} direction={"column"} gap={"15px"}>
            ...
            >
              Place your order and get ready to embark on a delicious adventure!
              Each box is packed with carefully chosen wines, ready to transport
              your taste buds to a new corner of the world.
            </Typography>
          </Stack>
        </Box>
      </Box>
