  ...
  return (
    ...
    >
      <Box sx={{ maxWidth: "600px", marginLeft: "60px"}}>
        <Typography variant="h4" sx={{marginBottom: "22px"}}>COUNTRY SPECIFIC BOXES:</Typography>
        <Typography variant="h3" sx={{marginBottom: "60px"}}>
          Immerse yourself in the unique flavors and traditions of Georgia, Italy, Germany, France, Ukraine, and Spain, with hand-picked wines by local experts.
        </Typography>
        <CustomButton
          color="primary"
          text="CHOOSE BOX"
